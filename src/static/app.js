document.addEventListener("DOMContentLoaded", () => {
  ...
  activitiesList.addEventListener("click", async (event) => {
    ...
    const activity = deleteURIComponentSafe(deleteButton.dataset.activity);
    const email = deleteURIComponentSafe(deleteButton.dataset.email);
  ...
  function deleteURIComponentSafe(value) {
    try {
